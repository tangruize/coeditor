...
#    xterm -e "$EXE $INVOKE_COEDITOR_ARGS -od" &
    TRY_TIMES=30
    ...
    PIDS[$((k-1))]=$EXE_PID
    ${EXE_DIR}/jupiter-ot 0< ${LOCAL_OP} 1>| ${LOCAL_OP_IN} 3< ${SERVER_OP} 4>| ${SERVER_OP_IN} 5< ${LOCAL_OP_IN_F} 6< ${SERVER_OP_IN_F} 2> ${EDIT_DIR}/.ot.${i} $SLEEP_TIME &
...
${EXE_DIR}/reproduce.sh /tmp/jupiter-server-d41d8cd98f00b204e9800998ecf8427e > /dev/null &
